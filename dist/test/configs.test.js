...
describe("Configs - No config", function () {
    ...
    it("Config should have 1 token and defaultMintAmount", function () {
        (0, chai_1.expect)(this.hre.config.fakeERC20Network).to.eql(utils_1.defaultSettings);
    });
});
/*
...
describe("Config - Partial config - No Token", function () {
    (0, helpers_1.useEnvironment)("partial-config-no-token");
    it("Config should have 1 token and defaultMintAmount", function () {
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.tokens).to.eql(utils_1.defaultSettings.tokens);
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.defaultMintAmount).to.equal("70000000000000000000");
    });
});
/*
...
describe("Config - Partial config - No defaultMintAmount", function () {
    (0, helpers_1.useEnvironment)("partial-config-no-defaultMintAmount");
    it("Config should have 2 tokens and defaultMintAmount", function () {
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.tokens.length).to.equal(2);
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.tokens[0].symbol).to.equal("GOLD");
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.tokens[1].symbol).to.equal("SILVER");
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.defaultMintAmount).to.equal(utils_1.defaultSettings.defaultMintAmount);
    });
});
/*
...
describe("Config - Full config", function () {
    ...
    it("Config should have 3 tokens and defaultMintAmount", function () {
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.tokens.length).to.equal(3);
        (0, chai_1.expect)(this.hre.config.fakeERC20Network.defaultMintAmount).to.equal("80000000000000000000");
    });
});
